...
import { formatDate, getStatusBadge, getStatusLabel, cn } from '@/lib/utils';

export default function KatalogKRLPage() {
  ...
  const fetchFilters = async () => {
    try {
      ...
      const krlStations = stationsRes.data.data.filter(
        (s) => s.tipe.includes('KRL') || s.tipe.includes('KEDUA')
      );
      setStations(krlStations);
    } catch (error) {
      ...
      <header className="bg-kai-primary text-white">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold">KRL Commuter Line</h1>
          ...
          <form onSubmit={handleSearch} className="relative">
            ...
            <input
              type="text"
              placeholder="Cari nama barang, warna, ciri-ciri..."
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={cn(
                  'btn-ghost gap-2',
                  showFilterPanel && 'bg-kai-primary/10 text-kai-primary'
                )}
              >
                <Filter className="h-4 w-4" />
                Filter
                {activeFilterCount > 0 && (
                  <span className="bg-kai-primary text-white text-xs px-2 py-0.5 rounded-full">
                    {activeFilterCount}
                  </span>
                )}
              </button>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleFilterChange('stasiun_id', e.target.value)}
                    className="input"
                  >
                    <option value="">Semua</option>
                    {stations.map((s) => (
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {barang.map((item) => (
                  ...
                  >
                    ...
                    <div className="p-3">
                      <h3 className="font-medium text-sm truncate group-hover:text-kai-primary">
                        {item.nama}
                      </h3>
                        ...
                        <div className="flex items-start justify-between">
                          <div>
                            ...
                            <p className="text-sm text-gray-500">
                              {item.kategori?.icon} {item.kategori?.nama} • {item.warna || '-'}
                            </p>
                          </div>
